...
// `Math.random` (generates random number). For this exercise, you'll
// be re-implementing some of those manually.
...
/**  MATH.FLOOR  **/
// This useful function takes a number and drops any decimal values 
// by rounding it down to the nearest integer.
...
// news is you won't have to handle fractional exponents, only integers.
...
// the `arguments` object so that you can compare any number of inputs.
