...
// manually, we'll have to pass in the array as the first argument.
...
// Example Usage:
// var array = [6, 7, 8];
// array.pop();    --> returns 8, and `array` is now [6, 7]
...
/**  PUSH  **/
// The opposite of `pop`, this adds new values to the end of an array, 
// and returns the new length. Normally it can accept any number of 
// values, but let's keep things simple for now and just accept one.

// Example Usage:
// var array = [6, 7, 8];
// array.push(9);    --> returns 4, and `array` is now [6, 7, 8, 9]
...
// Example Usage:
// var array = [6, 7, 8];
// array.shift();    --> returns 6, and `array` is now [7, 8]
...
// you'll need to use `arguments` to handle every input.

// Example Usage:
// var array = [6, 7, 8];
// array.unshift(3, 4, 5);    --> returns 6, and `array` is now [3, 4, 5, 6, 7, 8]
...
// Example Usage:
// var array = [3, 4, 5]
// array.reverse()    --> returns [5, 4, 3] and `array` is now [5, 4, 3]
